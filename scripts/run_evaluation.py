""" Make script to run evalutions on the test set.
...
Please note it can takes hours to pull the NWP data.
The data will be cached locally so next time you run it, itll be much quickerl
"""
