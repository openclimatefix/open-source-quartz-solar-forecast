...
pv_ids = [ 8215,  8229,  8253,  8266,  8267,  8281, 16474, 16477, 16480,
       16483,  8376, 16570, 16597,  8411,  8412,  8419,  8420,  8453,
        8464,  8505, 16715, 16717,  8551,  8558, 16769, 16770,  8587,
        8591,  8612,  8648,  8670,  8708,  8713, 16920, 16921,  8801,
       17034, 17035,  8856, 17062,  8914, 17166,  9069,  9070,  9101,
        9107, 17333,  9153,  9171,  9173]

np.random.seed(42)


def make_test_set(
    output_file_name: Optional[str] = None, number_of_samples_per_system: int = 50
):
    """
